...
import {LineStyle, Timeline, TrendingUp, Report, WorkOutline,  ChatBubbleOutline,  
    DynamicFeed, MailOutline, BarChart, AttachMoney,  Storefront, PermIdentity} from '@mui/icons-material'
import './sidebar.css'
    ...
    <div className='sidebar'>
        ...
        <div className='sidebarMenu' >
            ...
            <ul className='sidebarList'>
                ...
                <Link to="/products" className='link'> <li className='sidebarListItem' > < Storefront className='sidebarIcon' />  Products </li> </Link>
